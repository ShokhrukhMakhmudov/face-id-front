...
export default function Login() {
  ...
  return (
    <section className="loginPage flex flex-col items-center justify-center">
      <div className="">
        <div className="flex flex-col items-center border py-5 rounded-xl shadow-2xl px-10 backdrop-filter backdrop-blur">
          ...
          <form
            className="flex flex-col max-w-[400px] sm:w-[400px]"
          ...
          {error && (
            <p className="text-white bg-red-500 px-2 font-bold">{error}</p>
          )}
        </div>
      </div>
      {loading && <Loader />}
